...
#        }
        ...
        return [
            nlp.SplitGenerator(name=nlp.Split.TRAIN, gen_kwargs={"filepath": "/content/drive/My Drive/question_generation/question_generation/data/tweet_manual_multitask/tweet_train_squad_manual_edit.json"}),
            nlp.SplitGenerator(name=nlp.Split.VALIDATION, gen_kwargs={"filepath": "/content/drive/My Drive/question_generation/question_generation/data/tweet_manual_multitask/tweet_dev_squad_manual_edit.json"}),
        ]
